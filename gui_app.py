...
By default, choose Wayland if the session is Wayland; otherwise use XCB.
Users can override via the environment.
"""
...
if "QT_QPA_PLATFORM" not in os.environ:
    if _session == "wayland":
        ...
        # Fallback to xcb; users may switch to wayland manually if available
        os.environ["QT_QPA_PLATFORM"] = "xcb"
